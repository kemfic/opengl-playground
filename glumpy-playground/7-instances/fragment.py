...
varying vec2      v_texcoord0; // Interpolated fragment texture coordinates (in)
varying vec2      v_texcoord1; // used for stacking textures
void main()
{
    // Get texture color
    vec4 t0 = texture2D(u_texture, v_texcoord0);
    vec4 t1 = texture2D(u_texture, v_texcoord1);
